...
const BookingLongBoat= () => {
    ...
    return (
        <div className="hero flex justify-evenly" style={{ backgroundImage: `url("https://images.unsplash.com/photo-1470645792662-dd18394f8c97?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=869&q=80")` }}>
            <div className="card w-96 glass">
                <figure><img src="https://images.unsplash.com/photo-1563296291-14f26f10c20f?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1032&q=80" alt="car!"/></figure>
                <div className="card-body">
                    <h1 className='text-2xl text-center'>Booking Long Boat Seat</h1>
...
export default BookingLongBoat;