...
const CruiseBooking= () => {
    ...
    return (
        <div className="hero flex justify-evenly" style={{ backgroundImage: `url("https://images.unsplash.com/photo-1599640842225-85d111c60e6b?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=774&q=80")` }}>
            <div className="card w-96 glass">
                <figure><img src="https://images.unsplash.com/photo-1578530332818-6ba472e67b9f?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=872&q=80" alt="car!"/></figure>
                <div className="card-body">
                <h1 className='text-2xl text-center'>Booking Cruise Seat</h1>
